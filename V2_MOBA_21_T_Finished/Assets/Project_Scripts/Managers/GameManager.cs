...
public class GameManager : NetworkBehaviour
{
	...
	//this is static so Player can be added even withotu the scene loaded (i.e. from lobby)
	static public List<PlayerManager> m_Players = new List<PlayerManager>();             // A collection of managers for enabling and disabling different aspects of the Players.
	...
	private bool OnePlayerLeft()
	{
		...
		for (int i = 0; i < m_Players.Count; i++)
		{
			...
			if (m_Players[i].m_PlayerGEO.activeSelf)
				numPlayersLeft++;
		}
